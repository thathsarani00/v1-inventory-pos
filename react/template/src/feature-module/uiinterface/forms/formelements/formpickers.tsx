                            ...
                            <div className="card-body">
                                <div className="row gap-3">
                                    ...
                                    <div className="col-md-6 col-12 mb-6">
                                        <label htmlFor="flatpickr-date" className="form-label me-4">
                                            Date Picker
                                        </label>
                                    ...
                                    {/* Time Picker*/}
                                    <div className="col-md-6 col-12 mb-6">
                                        <label htmlFor="flatpickr-time" className="form-label me-4">
                                            Time Picker
                                        </label>
                                    ...
                                    {/* Range Picker*/}
                                    <div className="col-md-6 col-12 mb-6">
                                        <label htmlFor="flatpickr-range" className="form-label me-4">
                                            Range Picker
                                        </label>
                                        <RangePicker />
                                    </div>
